            ...
            <div className="w-full md:w-[35%] flex flex-col justify-center px-6 bg-white pointer-events-auto">
              ...
              <p className="text-base md:text-lg font-medium leading-relaxed text-[#570326]">
                <em>
                  ...
                  convinced by everyone. There’s only benefits when I came here.
                  Alhamdulillah, it’s also properly segregated.
                </em>
              </p>
        ...
        <SwiperSlide>
          <div className="flex h-full bg-[#570326]">
            ...
            <div className="w-full md:w-[35%] flex flex-col justify-center px-6 bg-white pointer-events-auto">
              ...
              <p className="text-base md:text-lg font-medium leading-relaxed text-[#570326]">
                <em>
                  It’s being around people from different universities and how
                  we come together for one [goal] - getting closer to our deen.
                </em>
              </p>
              <div className="flex items-center gap-4 mt-4">
                <img
            ...
            <div className="w-full md:w-[35%] flex flex-col justify-center px-6 bg-white pointer-events-auto">
              ...
              <p className="text-base md:text-lg font-medium leading-relaxed text-[#570326]">
                <em>
                  ...
                  Also the lectures, they’re very informative and insightful
                  mashaAllah.
                </em>
              </p>
              <div className="flex items-center gap-4 mt-4">
